...
export default class Footer extends Component {
    render () {
        return( 
            <div>            
                <a href="https://www.linkedin.com/in/matthew-riente-514880154/"><img class="linked-icon" src={linkedin} alt="linkedin" /></a>
                <p><small>All images used for educational purposes</small></p>
                <a href="https://www.roadtohire.org/"><img class="r2h-icon" src={r2h} alt="r2h" /></a>
